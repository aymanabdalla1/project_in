...
const tagImageMap = {
  ...
  'typescript': "/logos/javascript-original.svg",
  'python': "/logos/python-original.svg",
  'java': "/logos/java-original.svg",
  'c': "/logos/c-original.svg",
  'react': "/logos/react-original.svg",
  'tailwind': "/logos/tailwindcss-original.svg",
  'swift': "/logos/swift-original.svg",
  'nextjs': "/logos/nextjs-original.svg",
  'azure': "/logos/azure-original.svg",
  'angular': "/logos/angularjs-original.svg",
  // Add more tags and images as needed
};
...
const SingleBlog = ({ blog }: { blog: Blog}) => {
  ...
  // Get the image URL based on the tag value
    ...
    <>
      ...
      <div className="flex flex-wrap gap-4">
        {tags.map((tag) => (
          <img
            key={tag}
            src={tagImageMap[tag] || "/logos/default.svg"} // Use a default image if tag is not found
            alt={`Image for ${tag}`}
