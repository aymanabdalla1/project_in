                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex justify-content-end">
                            <Link href={'/categories/machinelearning/' + json1.routeTitle}><button className="btn btn-primary">Hello</button></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid mt-2 w-75 p-1">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex justify-content-end">
                            <Link href={'/categories/machinelearning/' + json2.routeTitle}><button className="btn btn-primary">Leer artículo</button></Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid mt-2 w-75 p-1">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex justify-content-end">
                            <Link href={'/categories/machinelearning/' + json3.routeTitle}><button className="btn btn-primary">Leer artículo</button></Link>
                        </div>
                    </div>
                </div>
            </div>
